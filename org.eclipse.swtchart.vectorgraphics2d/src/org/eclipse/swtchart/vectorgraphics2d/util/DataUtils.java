...
public abstract class DataUtils {
	...
	private static final DecimalFormat FLOAT_FORMAT = new DecimalFormat("0", DecimalFormatSymbols.getInstance(Locale.ENGLISH));
	static {
	 ...
	 *            Separator string.
	 * @param elements
	 *            Array of elements that should be concatenated.
	 * @return a concatenated string.
	 */
	 ...
	 *            Separator string.
	 * @param elements
	 *            Array of double numbers that should be concatenated.
	 * @return a concatenated string.
	 */
	 ...
	 *            Separator string.
	 * @param elements
	 *            Array of float numbers that should be concatenated.
	 * @return a concatenated string.
	 */
