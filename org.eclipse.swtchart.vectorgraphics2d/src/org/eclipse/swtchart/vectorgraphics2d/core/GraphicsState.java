...
public class GraphicsState implements Cloneable {
	...
	private static Shape transformShape(Shape s, AffineTransform tx) {
		...
		int nonRectlinearTxMask = AffineTransform.TYPE_GENERAL_TRANSFORM | AffineTransform.TYPE_GENERAL_ROTATION;
	...
	public boolean isDefault() {
		...
		return hints.isEmpty() && background.equals(DEFAULT_BACKGROUND) && color.equals(DEFAULT_COLOR) && composite.equals(DEFAULT_COMPOSITE) && font.equals(DEFAULT_FONT) && paint.equals(DEFAULT_PAINT) && stroke.equals(DEFAULT_STROKE) && transform.equals(DEFAULT_TRANSFORM) && xorMode.equals(DEFAULT_XOR_MODE) && clip == DEFAULT_CLIP;
	}
}
