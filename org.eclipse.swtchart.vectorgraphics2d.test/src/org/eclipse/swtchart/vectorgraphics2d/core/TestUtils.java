...
public abstract class TestUtils {
	...
	public static class XMLFragment {
		...
		public enum FragmentType {
			START_TAG, END_TAG, EMPTY_ELEMENT, CDATA, DECLARATION, DOCTYPE, COMMENT
		}
		...
		public XMLFragment(String name, FragmentType type, Map<String, String> attributes, int matchStart, int matchEnd) {
		...
		public boolean equals(Object o) {
			...
			while(itThis.hasNext() && itFrag.hasNext()) {
				...
				if(!attrThis.getKey().equals(attrFrag.getKey()) || !attrThis.getValue().equals(attrFrag.getValue())) {
					return false;
				}
			}
			return true;
