...
public class ResetYAxisHandler extends AbstractChartMenuEntry implements IChartMenuEntry {
	...
	public String getName() {
		...
		return Messages.getString(Messages.RESET_Y_AXIS);
	}

	@Override
	public void execute(Shell shell, ScrollableChart scrollableChart) {

		scrollableChart.adjustYAxis();
	}
}
