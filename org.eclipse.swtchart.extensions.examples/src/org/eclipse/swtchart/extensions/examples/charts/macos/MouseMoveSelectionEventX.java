...
public class MouseMoveSelectionEventX extends MouseMoveSelectionEvent {
	...
	public void handleEvent(BaseChart baseChart, Event event) {
		...
		System.out.println("MouseMoveSelection (Handler): " + event);
		super.handleEvent(baseChart, event);
	}

	protected boolean isSingleClick(Event event) {

		System.out.println("Event (MouseMoveSelection): " + event);
